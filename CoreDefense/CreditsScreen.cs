...
namespace CoreDefense
{
    public class CreditsScreen : Screen
    {
        ...
        public static CreditsScreen Init 
        {
            get 
            {
                if (Instance == null)
        ...
        {
            creditsScreenTexture = content.Load<Texture2D>("Image\\creditsScreen");
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(creditsScreenTexture, Vector2.Zero, Color.White);
